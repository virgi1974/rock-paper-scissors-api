...
RSpec.describe 'games API', :type => :request do  
  describe 'GET api/v1/games' do
    context 'expected general behaviour' do
      ...
      it 'has expected structure' do
        ...
        expected_response_keys = ['total_games', 'games']
    ...
    context 'with stored games' do
      ...
      it 'returns expected content' do
        expected_game_keys = ['username', 'user_movement', 'bot_movement', 'result', 'played_at']
  ...
  describe 'POST /api/v1/games' do
    ...
    context 'when the request is valid' do
      ...
      it 'has expected structure' do
        expected_created_game_keys = ['moves', 'result']
    ...
    context 'when the request is invalid' do
      ...
      context 'user exists' do
        ...
        it 'movement not valid' do
          ...
          expect(allowed_movements).to_not include(invalid_move_attributes[:move])
        end
